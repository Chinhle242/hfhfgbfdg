...
function get_link_total($url,$episode_id) {
	...
	$link=$url;
	$mylink='http://phimnhanh360.com/grab/'.encode();
if (preg_match('#veoh.com/browse/videos/category/([^/]+)/watch/([^/]+)#', $url, $id_sr)){
		$id = $id_sr[2];
		$link=$mylink.'/veoh/'.$id.'.flv';
		$url="http://www.phim88.com/online/xxxxxx?plugins=$web_link/vuaphim.swf&plugin.thienduongviet=true&plugin.tdv_id=xml_video/$episode_id&autostart=true&skin=http://phimnhanh360.com/video/skewd.xml&autostart=true";
    }
	...
	elseif (preg_match("#gdata.youtube.com/#",$url,$id_sr)) {
		$url=$web_link.'/'.'player.swf?file='.$url.'&playlist=over&&autostart=true&skin=http://phimnhanh360.com/stylish.swf&repeat=list';
    }
	...
	elseif (preg_match('#2shared.com/([^/]+)#', $url, $id)){
		$url="http://www.2shared.com/flash/player.swf?plugins=http://vuaphim.net/vuaphim.swf&plugin.thienduongviet=true&plugin.tdv_id=xml_video/$episode_id&autostart=true&skin=$web_link/skin.swf";	
	}
	else if (preg_match("#4shared.com/(.*?)#s", $link)){
		$id = cut_str('/',$link,4);
		$link=$mylink.'/4shared/'.$id.'.flv';
		$url='http://www.4shared.com/flash/player.swf?file='.$link."&skin=http://phimnhanh360.com/video/skewd.xml&autostart=true";
                //$url="http://www.4shared.com/flash/player.swf?plugins=http://phimnhanh360.com/vuaphim.swf&plugin.thienduongviet=true&plugin.tdv_id=xml_video/$episode_id&autostart=true&skin=http://phimnhanh360.com/skin.swf";		
	}
		...
		$id =str_replace(array('http://www.viddler.com/explore/','/'),array('','-'),$link);
		$link=$mylink.'/viddler/'.$id.'.flv';
		$url="http://phimnhanh360.com/player/mediaplayer.swf?pathlateral=true&type=video&file=$link";	
		...
		$url="http://phimnhanh360.com/player/vixden_check.swf?plugins=http://phimnhanh360.com/phimnhanh360.swf&phimnhanh360.file=$url&phimnhanh360.img=http://phimnhanh360.com/player/screen_play.png&skin=http://phimnhanh360.com/video/skewd.xml";	
	}
	else if (preg_match("#novamov.com/video/(.*?)#s", $url)){
		$url="http://phimnhanh360.com/player/mediaplayer.swf?file=$url&amp;pathlateral=true&amp;type=video&amp;";	
	}
		...
		$url="http://phimnhanh360.com/player/mediaplayer.swf?pathlateral=true&type=video&file=$url";	
	}
		...
		$url="http://www.vidxden.com/player/player.swf?plugins=http://phimnhanh360.com/phimnhanh360.swf&phimnhanh360.file=$url&phimnhanh360.img=http://phimnhanh360.com/player/screen_play.png&skin=http://phimnhanh360.com/video/skewd.xml";	
	}
