$(document).ready(function(){
    ...
    $("[id*='star_']").click(function(event) {
        ...
        var film_id    = id_split[3];
        $("#rating_text").html('<b>Thanks for rating!</b>');
    /*  $.post(base_url + 'index.php', { rating: 1, film_id: film_id, star: rating },
        function (response) {
	...
	*/
    ...
    $("[id*='star_']").mouseover(function(){
        ...
        if ( rating == 1 ) {
            $('#rating_text').html('<b>K&eacute;m</b>');
        } else if ( rating == 2 ) {
            $('#rating_text').html('<b>B&igrave;nh Th&#432;&#7901;ng</b>');
        } else if ( rating == 3 ) {
            $('#rating_text').html('<b>&#272;&#432;&#7907;c</b>');
        } else if ( rating == 4 ) {
            $('#rating_text').html('<b>Hay</b>');
        } else if ( rating == 5 ) {
            $('#rating_text').html('<b>Tuy&#7879;t V&#7901;i</b>');
        }
    });
    ...
    $("a#show_related_videos").click(function(event) {
        ...
        $("#video_comments").hide();
        $("#related_videos").show();
		$('a#show_related_videos').addClass('active');
		$('a#show_comments').removeClass('active');
    });
    ...
    $("a#show_comments").click(function(event) {
        ...
        $("#related_videos").hide();
        $("#video_comments").show();
		$('a#show_related_videos').removeClass('active');
		$('a#show_comments').addClass('active');
    });
