...
{
	global $useheader,$useragent,$referer,$autoreferer,$usehttpheader,$ucookie,$encoding,$timeout,$follow,$mpost,$mpostfield,$proxytunnel,$proxytype,$proxyport,$proxyip,$nobody;
	$curl = curl_init();
