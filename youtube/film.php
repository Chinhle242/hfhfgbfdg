...

{
	...
	$trailers_button ='<a title="watch trailers" href="'.$web_link.'/watch-trailer/'.replace($r['film_name_ascii']).'_'.$trailers['trailers_id'].'.html" target="_blank"><img src="http://vuaphim.vn/skin/tmp/images/watch_trailer.png" /></a>';
